# 用途 | Purpose:
# - 运行 Dipteronia dyeriana 的单物种 MaxEnt 分析。
# - Run the single-species MaxEnt analysis for Dipteronia dyeriana.
# 输入 | Inputs:
...
# 输出 | Outputs:
# - 在 Ddye_50kmBuffer 下输出背景点、occurrence 表、MaxEnt 评估结果和图件。
# - Write background points, occurrence tables, MaxEnt evaluation results, and figures under Ddye_50kmBuffer.
# 使用提示 | Usage Notes:
