...
本目录提供与 Acer 相关研究分析配套的公开代码与部分示例数据，面向需要查看、复现或在本地继续分析的用户。
...
安装最小 Python 依赖 / Install minimal Python dependencies:

```bash
python install_minimal_dependencies.py
```

仅查看安装命令 / Preview without installing:
...
按模块检查 / Check specific workflow groups:
