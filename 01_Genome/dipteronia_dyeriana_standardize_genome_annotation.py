"""
用途 | Purpose:
- 标准化 Dipteronia dyeriana（Ddye）的基因组注释与序列命名，生成发布版 GFF3、genome、CDS、pep 及 ID 映射表。
- Standardize the annotation and sequence naming for Dipteronia dyeriana (Ddye) and generate release-ready GFF3, genome, CDS, peptide files, and ID mapping tables.
输入 | Inputs:
...
file_input_gff3 = resolve_input_path("Dipteronia_genomes", "yunnanjinqianqi", "03.structure_annotation", "pasa2.longest.filter.gff3")
...
file_input_genome = resolve_input_path("Dipteronia_genomes", "yunnanjinqianqi", "00.Genome", "Did.genome.fa")
...
file_input_cds = resolve_input_path("Dipteronia_genomes", "yunnanjinqianqi", "03.structure_annotation", "pasa2.longest.filter.cds")
...
file_input_pep = resolve_input_path("Dipteronia_genomes", "yunnanjinqianqi", "03.structure_annotation", "pasa2.longest.filter.pep")
